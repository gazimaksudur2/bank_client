...
import { CiCoinInsert, CiInboxIn, CiInboxOut } from 'react-icons/ci';
...
const TransactionRow = () => {
    return (
        <tr>
            ...
            <td class="px-4 py-4 text-sm text-gray-500 whitespace-nowrap">$120</td>
            <td class="px-4 py-4 text-sm text-gray-500 whitespace-nowrap">{new Date().toLocaleString()}</td>
            <td class="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">

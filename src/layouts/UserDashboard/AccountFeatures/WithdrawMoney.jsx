    ...
    const modalDialog = <dialog id="my_modal_1" className="modal">
        <div className="modal-box">
            ...
            <div className="modal-action">
                <form method="dialog" onSubmit={handleWithdraw}>
            ...
            <div className="hero h-[50vh] bg-white">
                <div className="w-[80%] mx-auto flex justify-between items-center flex-col lg:flex-row-reverse">
                    <div className='flex flex-col items-center gap-4'>
                        <img className="w-64 mask mask-squircle" src="https://img.freepik.com/free-vector/e-wallet-money-transfer-concept-mobile-wallet-internet-banking-e-wallet-credit-card-mobile-app-accounting-investments-safe-online-internet-transaction-vector-illustration_1150-55440.jpg?uid=R113556208&ga=GA1.1.1491027022.1736420044&semt=ais_hybrid" />
                        <h4 className='text-lg font-medium'>Withdraw funds to your linked account or wallet</h4>
                    </div>
                    <div className='w-[60%]'>
                        <h2 class="text-xl font-semibold text-gray-700 capitalize">Withdraw funds </h2>
